  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={[styles.badge, { backgroundColor: STATUS_BG[student.status] }]}>
          <Text style={[styles.badgeText, { color: STATUS_COLOR[student.status] }]}>
        ...
        {(student.status === "danger" || student.status === "warn") && (
          ...
          >
            <View style={{ flexDirection: "row", alignItems: "center", gap: 8, marginBottom: 8 }}>
              ...
              <Text style={[styles.warnTitle, { color: STATUS_COLOR[student.status] }]}>
                {student.status === "danger"
...
const styles = StyleSheet.create({
  ...
  title: { color: colors.foreground, fontFamily: fonts.display, fontSize: 16, flex: 1 },
  ...
  exerciseName: { color: colors.foreground, fontFamily: fonts.display, fontSize: 22 },
